...
public class Lifecycles extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if (savedInstanceState != null) {
            ...
            persistentState = savedInstanceState.getString(persistentState);
        }
    ...
    outState.putString(persistentState, persistentState);
    ...
    private void saveSharedPreferences(){
        ...
        editor.putString("KEY_ONE", persistentState);
        editor.putString("KEY_TWO", nonViewState);
        editor.commit();
    }

    private void restoreSharedPreferences(){
        SharedPreferences sharedPref = getPreferences(Context.MODE_PRIVATE);
        persistentState = sharedPref.getString("KEY_ONE", "");
        nonViewState = sharedPref.getString("KEY_TWO","");
    }
